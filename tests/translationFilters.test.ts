...
describe('translation filter policy', () => {
    it('keeps temporary visibility out of source protection', () => {
        const document = documentWith('<main aria-hidden="true"><p id="copy">Stable copy.</p></main>');
        ...
        expect(core.shouldStayOriginalForSource(copy)).toBe(true);
    });
