...
const PREVIEW_STYLE = `
:root { --babelbox-preview-font-small: 11px; --babelbox-preview-font-body: 13px; --babelbox-preview-font-subtitle: 15px; --babelbox-preview-font-reading: 17px; --babelbox-preview-weight-regular: 400; --babelbox-preview-weight-medium: 600; --babelbox-preview-weight-semibold: 700; --babelbox-preview-weight-bold: 800; color-scheme: light; font-family: Inter, "SF Pro Text", "PingFang SC", "Microsoft YaHei", system-ui, sans-serif; color: #20242d; background: #fff; }
* { box-sizing: border-box; }
html, body { min-height: 100%; margin: 0; }
body { max-width: 900px; margin: 0 auto; padding: 54px 64px 80px; font-size: var(--babelbox-preview-font-reading); line-height: 1.78; overflow-wrap: anywhere; }
...
pre { margin: 1.1em 0; padding: 16px 18px; overflow: auto; border: 1px solid #e4e7ef; border-radius: 12px; background: #f7f8fb; font-size: var(--babelbox-preview-font-body); line-height: 1.6; }
...
[data-babelbox-document-translation="true"], .babelbox-translation { display: block; margin-top: .3em; color: #232831; font-weight: var(--babelbox-preview-weight-medium); }
.reader-unit { margin: 0 0 1.35em; }
.reader-unit > :first-child { margin-bottom: .22em; }
.reader-unit > :last-child { margin-bottom: 0; }
.reader-source { color: #303640; font-weight: var(--babelbox-preview-weight-regular); }
.reader-translation { color: #20242d; font-weight: var(--babelbox-preview-weight-semibold); }
.reader-unit.heading .reader-source, .reader-unit.heading .reader-translation { font-weight: var(--babelbox-preview-weight-bold); }
...
.document-security-note { margin: 0 0 24px; padding: 9px 12px; border-radius: 9px; color: #6c7485; background: #f7f8fb; font-size: var(--babelbox-preview-font-small); }
@media (max-width: 680px) { body { padding: 30px 24px 56px; font-size: var(--babelbox-preview-font-subtitle); } }
`;
...
function pairedUnit(
    ...
    const translatedNode = `<${tag} class="reader-translation babelbox-translation">${translatedText}</${tag}>`;
